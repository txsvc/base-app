...
class Google::Cloud::Env
  ...
  def env; end
  def initialize(env: nil, connection: nil, metadata_cache: nil, open_timeout: nil, request_timeout: nil, retry_count: nil, retry_interval: nil, retry_backoff_factor: nil, retry_max_interval: nil); end
