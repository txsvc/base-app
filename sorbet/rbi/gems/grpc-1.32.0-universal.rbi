...
#
#   https://github.com/sorbet/sorbet-typed/new/master?filename=lib/grpc-1.32.0-universal/all/grpc-1.32.0-universal.rbi
#
...
class GRPC::BadStatus < StandardError
  ...
  def debug_error_string; end
  def details; end
  def initialize(code, details = nil, metadata = nil, debug_error_string = nil); end
  def metadata; end
  def self.new_status_exception(code, details = nil, metadata = nil, debug_error_string = nil); end
  def to_rpc_status; end
  def to_status; end
  include GRPC::Core::StatusCodes
end
class GRPC::Ok < GRPC::BadStatus
  def initialize(details = nil, metadata = nil, debug_error_string = nil); end
end
...
class GRPC::RpcDesc < Anonymous_Struct_73
